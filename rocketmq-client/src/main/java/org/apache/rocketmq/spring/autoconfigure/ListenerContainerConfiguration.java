...
//
        ...
        createRocketMQListenerContainer(containerBeanName, bean, annotation, beanDefinitionBuilder);
        genericApplicationContext.registerBeanDefinition(containerBeanName, beanDefinitionBuilder.getRawBeanDefinition());
    ...
    private void createRocketMQListenerContainer(String name, Object bean, RocketMQMessageListener annotation, BeanDefinitionBuilder beanDefinitionBuilder) {
//        DefaultRocketMQListenerContainer container = new DefaultRocketMQListenerContainer();
        beanDefinitionBuilder.addPropertyValue("rocketMQMessageListener", annotation);
        beanDefinitionBuilder.addPropertyValue("consumeMode", annotation.consumeMode());
        beanDefinitionBuilder.addPropertyValue("consumeThreadMax", annotation.consumeThreadMax());
        beanDefinitionBuilder.addPropertyValue("messageModel", annotation.messageModel());
        beanDefinitionBuilder.addPropertyValue("selectorType", annotation.selectorType());
        beanDefinitionBuilder.addPropertyValue("selectorExpression", annotation.selectorExpression());
        beanDefinitionBuilder.addPropertyValue("consumeTimeout", annotation.consumeTimeout());
...
//        container.setConsumerGroup(environment.resolvePlaceholders(annotation.consumerGroup()));
        if (RocketMQListener.class.isAssignableFrom(bean.getClass())) {
            beanDefinitionBuilder.addPropertyValue("rocketMQListener", (RocketMQListener) bean);

            //  container.setRocketMQListener((RocketMQListener) bean);
        } else if (RocketMQReplyListener.class.isAssignableFrom(bean.getClass())) {
            beanDefinitionBuilder.addPropertyValue("rocketMQReplyListener", (RocketMQReplyListener) bean);
